  ...
  return (
    <div id="roadSection" className="  container   tw-pb-12">
      <div className="  sm:tw-pb-0 ">
        <span className="tw-text-white tw-font-zen-dots  tw-font-semibold tw-text-[18px] tw-justify-center tw-flex tw-items-center tw-gap-4">
          {" "}
          <p className="tw-font-zen-dots tw-text-lg  sm:tw-block tw-hidden m-0 tw-w-16 tw-h-0.5 tw-bg-[#F90331]"></p>{" "}
          Road map{" "}
          <p className="tw-font-zen-dots tw-text-lg  sm:tw-block tw-hidden m-0 tw-w-16 tw-h-0.5 tw-bg-[#F90331]"></p>{" "}
        </span>
        <div className=" tw-text-center">
          <h1 className="tw-text-[#F90331] tw-pt-6 tw-font-zen-dots">
            Millionaire Maker
          </h1>
          <p>
        ...
        <div className="  tw-border-t tw-mt-16 tw-border-[#F90331]"></div>
  ...
  <div className="">
    <div className="row  tw-pt-3 tw-items-center">
      <div className={`col-md-3  tw-mx-auto `}>
        <div
          className={` tw-flex tw-justify-center tw-items-center  tw-border-[#F90331]   tw-pl-3 tw-border-l-2`}
        >
