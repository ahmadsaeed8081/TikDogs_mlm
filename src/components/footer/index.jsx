...
const Footer = () => {
  return (
    <div>
      ...
      <div className="tw-bg-[#f90331] tw-w-full tw-py-2  tw-text-center">
        <p className=" sm:tw-text-lg tw-text-sm tw-m-0 tw-text-black  tw-font-medium tw-font-poppins">
          Copyright @2024 tikdogs.com All Rights Reserved
        </p>
      </div>
    </div>
  );
