...
async function updateName1() {
  ...
  return (
    <>
      ...
      <section className="tw-bg-[#1c1919] sm:tw-pt-12 tw-pt-0 pb-12">
        <div className="tw-container tw-px-5 tw-mx-auto">
          <div className=" row">
            <div className="  col-md-4">
              <div className=" tw-flex tw-flex-col   tw-gap-5">
                <div className=" tw-bg-[#f90331]  tw-flex  tw-justify-center tw-gap-7    tw-p-5">
                  <div className="tw-relative">
                    <div className=" ">
                      <img
                        ...
                        alt="Profile"
                        className=" tw-w-32 tw-rounded-full tw-border-2 tw-border-[#F3FFB9]  tw-object-center tw-h-32"
                    ...
                    <div className="tw-absolute tw-top-24 tw-left-1.5">
                      <label
                        htmlFor="file-upload"
                        className="tw-cursor-pointer tw-text-black tw-bg-[#F3FFB9] tw-py-2  tw-px-6 tw-font-semibold tw-rounded-full tw-font-poppins tw-text-[16px]"
                      >
                        {badge}
                      </label>
                  ...
                  <div className=" tw-w-44">
                    ...
                    <button
                      ...
                      className="tw-flex tw-justify-center tw-items-center tw-gap-2 tw-text-black tw-bg-[#F3FFB9] tw-w-full tw-py-2 tw-rounded-full tw-mt-2 hover:tw-bg-[#E5B766] tw-transition-colors"
                    >
                    ...
                    {isOpen && (
                      <div className=" tw-pt-2.5 tw-flex tw-gap-4">
                        <div className="">
                          ...
                          <div
                            className=" tw-text-white tw-text-[12px] tw-border  tw-p-1    tw-leading-1 tw-border-[#F3FFB9] tw-font-poppins"
                ...
                <div className="tw-bg-[#f90331] tw-p-5">
                  <div className="tw-flex tw-gap-3">
                    ...
                    <div className=" tw-w-full">
                      ...
                      <button
                        className={`tw-border tw-text-white tw-font-poppins tw-font-medium tw-text-xl tw-border-[#F3FFB9] tw-w-full tw-rounded-lg tw-transition-all tw-duration-300   tw-p-2`}
                      >
                        <div className="tw-flex tw-flex-col tw-items-center tw-justify-center tw-gap-2">
                          ...
                          {/* <div className=" tw-flex tw-pt-1">
                            ...
                            <span className=" tw-font-poppins tw-text-[#f90331] tw-text-sm">
                      ...
                      >
                        <div className="tw-flex tw-flex-col tw-items-center tw-justify-center tw-gap-2">
                          ...
                          {/* <div className=" tw-flex tw-pt-1">
                            ...
                            <span className=" tw-font-poppins tw-text-sm tw-text-[#f90331]">
                ...
                <div className=" tw-bg-[#f90331] tw-p-5">
                  <div className=" tw-flex tw-justify-between tw-items-center">
                    <div className="  tw-gap-2">
                      <div>
                        <p className=" m-0 tw-text-[#F3FFB9] tw-font-poppins tw-text-xl">
                          Total Earning
                        </p>
                      </div>
                      ...
                      <div className=" tw-flex tw-items-center tw-pt-2 tw-gap-4">
                        ...
                        {/* <div className=" tw-flex tw-items-start">
                          ...
                          <span className=" tw-font-poppins tw-pt-1 tw-text-[#f90331]  tw-text-lg">
                            {props.recent_data[0]}
                          </span>
                        </div> */}
                      </div>
                ...
                <div className=" tw-bg-[#f90331] tw-p-5">
                  <div>
                    <div className=" tw-flex tw-gap-2">
                      <div>
                        <p className=" m-0 tw-text-[#F3FFB9] tw-font-poppins tw-text-xl tw-font-light">
                          Referral Link:
                        </p>
                      </div>
                      <div>
                ...
                <div className=" tw-bg-[#f90331] tw-flex  tw-flex-col tw-gap-4 tw-p-5">
                  <div className="  tw-flex tw-gap-5 tw-pt-4">
                    <div>
                      ...
                      <input
                        ...
                        className=" tw-border-[#F3FFB9]  tw-text-white tw-bg-transparent tw-rounded-md tw-w-full tw-p-2.5 tw-font-poppins tw-border"
                      />
                    </div>
                    <div>
                      <h6 className="  tw-font-normal tw-text-white tw-font-poppins tw-pb-1">
                  ...
                  <div className="  tw-flex tw-gap-5">
                    ...
                    <div className=" tw-w-[48%]">
                      ...
                      <div className="tw-border-[#F3FFB9] tw-flex tw-text-white tw-bg-transparent tw-rounded-md  tw-p-2 tw-font-poppins tw-border">
                        <input
                          value={"$"+ Number(props.monthlySalary)/10**6}
                          className=" tw-border-[#F3FFB9] tw-text-white tw-bg-transparent tw-outline-none tw-rounded-md tw-w-full tw-font-poppins"
                        />
                        <spa 
                        onClick={claim_monthlySalary}
                        className="tw-border-[#F3FFB9] tw-border-2 tw-rounded-md tw-px-3 tw-py-1  tw-text-sm">
                          Claim
                        </spa>
                      </div>
                      <div className=" tw-pt-2 tw-flex tw-gap-2 tw-justify-end tw-items-center">
                        <p className=" tw-m-0  tw-text-sm tw-font-poppins tw-text-white">
                          ...
                          <span className=" tw-text-[#f90331]"> D </span>
                        </p>
                        <p className=" tw-m-0  tw-text-sm tw-font-poppins tw-text-white">
                        ...
                        <p className=" tw-m-0  tw-text-sm tw-font-poppins tw-text-white">
                          ...
                          <span className=" tw-text-[#f90331]"> M </span>
                        </p>
                        <p className=" tw-m-0  tw-text-sm tw-font-poppins tw-text-white">
                          {String(timeLeft.seconds).padStart(2, "0")}
                          <span className=" tw-text-[#f90331]"> S </span>
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className=" tw-w-[48%]">
                      ...
                      <div className="tw-border-[#F3FFB9] tw-flex tw-text-white tw-bg-transparent tw-rounded-md  tw-p-2 tw-font-poppins tw-border">
                        <input
                          ...
                          className=" tw-border-[#F3FFB9] tw-text-white tw-bg-transparent tw-outline-none tw-rounded-md tw-w-full tw-font-poppins"
                        />
                        <spa className="tw-border-[#F3FFB9] tw-border-2 tw-rounded-md tw-px-3 tw-py-1  tw-text-sm">
                          Claim
                        </spa>
                      </div>
                      <div className=" tw-pt-2 tw-flex tw-gap-2 tw-justify-end tw-items-center">
            ...
            <div className="col-md-8">
              <div className=" ">
                <span className=" tw-text-white tw-pl-8 tw-font-zen-dots   md:tw-text-4xl sm:tw-text-3xl tw-text-2xl">
                  Level Program
                </span>
                  ...
                  {Level?.map((item, index) => {
                    ...
                    {!item.isjoined?(
                      ...
                      <Link
                        ...
                        className="tw-bg-[#f90331] tw-px-3 tw-py-2 tw-w-full tw-flex tw-items-center  tw-justify-between tw-rounded-tl-md"
                      >
                ...
                <div className=" tw-py-12 ">
                  <span className="  tw-pl-8 tw-font-zen-dots  tw-text-white   md:tw-text-2xl sm:tw-text-xl tw-text-lg">
                    Community/Activity
                  </span>
                  <div className="tw-overflow-x-auto tw-mt-6 tw-pt-8 tw-pb-3 tw-overflow-y-auto tw-bg-[#f90331]">
                    <h5 className=" tw-font-zen-dots tw-text-center tw-text-white">
                      Participants
                    </h5>

                    <table className="tw-min-w-full tw-mb-0 ">
                      <thead className="text-center tw-border-b tw-border-[#fff] tw-bg-[#f90331]">
                      ...
                      <tbody className=" ">
                        <>
                          <tr className="tw-bg-[#f90331] tw-rounded-md">
