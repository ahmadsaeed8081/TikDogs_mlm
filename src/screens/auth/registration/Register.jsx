            ...
            <div className=" col-lg-6  col-md-12  p-0">
              <div className="  tw-bg-register_bg sm:tw-p-16 tw-p-5">
                <h1 className="  text-white sm:tw-text-left tw-text-center tw-font-zen-dots  md:tw-text-5xl sm:tw-text-4xl tw-text-2xl">
                  Welcome to the{" "}
                  <span className=" tw-text-[#f90331] tw-font-zen-dots   md:tw-text-5xl sm:tw-text-4xl tw-text-2xl">
                    TikDogs.com{" "}
                  </span>
                </h1>
                ...
                <div className="row  g-4 tw-pt-12">
                  {teamMembers.map((member, index) => (
                    <div key={index} className="col-md-6">
                      <div className=" tw-rounded-xl tw-h-64 tw-p-5 tw-border tw-border-[#f90331]">
                        <div className="">
                          <div className="row">
            ...
            <div className=" col-lg-6 col-md-12">
              <div className="  sm:tw-text-left tw-text-center sm:tw-p-16 tw-p-5">
                <h1 className="  text-white   tw-font-zen-dots  md:tw-text-4xl sm:tw-text-3xl tw-text-2xl">
                  Registering for <br />
                  <span className=" tw-text-[#f90331] tw-font-zen-dots   md:tw-text-4xl sm:tw-text-3xl tw-text-2xl">
                    TikDogs.com
                  </span>
                </h1>
                ...
                <div className=" tw-flex tw-gap-3.5">
                  <button onClick={() => setSelectedOption("yes")} className={`tw-border ${selectedOption==='yes'?' tw-bg-[#f90331]  tw-text-black':' tw-text-white'}  tw-py-4 tw-font-medium tw-text-xl tw-border-[#f90331] tw-w-full tw-rounded-lg tw-transition-all tw-duration-300 hover:tw-bg-[#f90331] hover:tw-text-black`}>
                    Yes
                  </button>
                  <button   onClick={() => setSelectedOption("no")} className={`tw-border ${selectedOption==='no'?' tw-bg-[#f90331]  tw-text-black':' tw-text-white'}  tw-py-4 tw-font-medium tw-text-xl tw-border-[#f90331] tw-w-full tw-rounded-lg tw-transition-all tw-duration-300 hover:tw-bg-[#f90331] hover:tw-text-black`}>
                    No
                  </button>
                </div>
          ...
          <>
           ...
           <div className=" tw-pb-5">
             ...
             />
              ...
              <button  
              onClick={()=>Register(0)}
              className={`tw-border tw-text-black tw-py-4 tw-font-poppins tw-font-medium tw-text-xl tw-border-[#f90331] tw-w-full tw-rounded-lg tw-transition-all tw-duration-300 tw-bg-[#f90331] hover:tw-text-black`}>
                  Register
                  </button>
          </>
        ) : selectedOption === "no" ? (
